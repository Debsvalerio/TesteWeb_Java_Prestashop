...
public class HomePage {
	...
	private By descricoesDoProduto = By.cssSelector(".product-description a");
	...
	public int obbterQuantidadeProdutosNoCarrinho() {
	...
	public String obterNomeProduto(int indice) {
		return driver.findElements(descricoesDoProduto).get(indice).getText();
	...
	public ProdutoPage clicarProduto (int indice) {
		driver.findElements(descricoesDoProduto).get(indice).click();
	...
	public void clicarBotaoSingOut() {
