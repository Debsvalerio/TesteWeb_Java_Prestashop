...
public class ComprarProdutoSteps {
	...
	public static void inicializar() {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\de-va\\WebDrivers\\ChromeDrivers\\Versao 97\\chromedriver.exe");
	...
	public void carrinho_esta_zerado() {
		assertThat(homePage.obbterQuantidadeProdutosNoCarrinho(), is(0));
	}
	...
	@Quando("E nome do produto na tela principal e na tela produto eh {string}")
	...
	@Quando("E preco do produto na tela principal e na tela do produto eh {string}")
	...
	@After(order = 1)
	public void caputarTela(Scenario scenario) {
